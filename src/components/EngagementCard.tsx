...
export default function EngagementCard({ engagement }: EngagementProps) {
    return (
        <div className="flex-shrink-0 grid grid-rows-[4fr, 1fr, 1fr] gap-10 mr-28">
            ...
            <h3 className="uppercase font-bold relative text-lg before:content-[''] before:absolute before:top-[-25px] before:left-0 before:w-5 before:h-[2px] before:bg-black-950">{engagement.name}</h3>
