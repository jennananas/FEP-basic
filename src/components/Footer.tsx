export default function Footer() {
    ...
    return (
        ...
        <div className=" text-white bg-black-950">
            <section className="grid grid-cols-[1fr_1.5fr] grid-rows-[100px_1fr] px-20 py-24 gap-x-48 gap-y-10">
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="email" placeholder="Email Address" className="w-full placeholder:text-black
                        bg-transparent 
                        border-b-[1px] p-2 
                        focus:outline-none
                        "/>
            ...
            <footer className="h-[60px] bg-[#191918] 
